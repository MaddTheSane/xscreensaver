...
{
  char *ret = 0;
  NSFont *nsfont = (__bridge NSFont *) jwxyz_native_font (fid);
  CTFontRef ctfont =
  ...
  if (CTFontGetGlyphsForCharacters (ctfont, (UniChar *) &uc, &cgglyph, 1)) {
    ...
    NSString *name = (NSString *) CFBridgingRelease(CGFontCopyGlyphNameForGlyph(cgfont, cgglyph));
             ...
             const char *str, size_t len, int utf8_p)
{
  ...
  NSDictionary *attr =
    [NSDictionary dictionaryWithObjectsAndKeys:
     (__bridge NSFont *) jwxyz_native_font (gc->gcv.font), NSFontAttributeName,
